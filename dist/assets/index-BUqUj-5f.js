 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zs(n){if(n.code!==L.FAILED_PRECONDITION||n.message!==Tp)throw n;F("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ye="WebChannelConnection";class rg extends tg{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}vo(e,t,r,i){const o=Cs();return new Promise((a,c)=>{const u=new Ec;u.setWithCredentials(!0),u.listenOnce(Tc.COMPLETE,()=>{try{switch(u.getLastErrorCode()){case Mr.NO_ERROR:const p=u.getResponseJson();F(ye,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(p)),a(p);break;case Mr.TIMEOUT:F(ye,`RPC '${e}' ${o} timed out`),c(new j(L.DEADLINE_EXCEEDED,"Request time out"));break;case Mr.HTTP_ERROR:const y=u.getStatus();if(F(ye,`RPC '${e}' ${o} failed with status:`,y,"response text:",u.getResponseText()),y>0){let w=u.getResponseJson();Array.isArray(w)&&(w=w[0]);const C=w==null?void 0:w.error;if(C&&C.status&&C.message){const S=function(k){const b=k.toLowerCase().replace(/_/g,"-");return Object.values(L).indexOf(b)>=0?b:L.UNKNOWN}(C.status);c(new j(S,C.message))}else c(new j(L.UNKNOWN,"Server responded with status "+u.getStatus()))}else c(new j(L.UNAVAILABLE,"Connection failed."));break;default:z()}}finally{F(ye,`RPC '${e}' ${o} completed.`)}});const d=JSON.stringify(i);F(ye,`RPC '${e}' ${o} sending request:`,i),u.send(t,"POST",d,r,15)})}Wo(e,t,r){const i=Cs(),o=[this.po,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=Ac(),c=Ic(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(u.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(u.useFetchStreams=!0),this.Do(u.initMessageHeaders,t,r),u.encodeInitMessageHeaders=!0;const p=o.join("");F(ye,`Creating RPC '${e}' stream ${i}: ${p}`,u);const y=a.createWebChannel(p,u);let w=!1,C=!1;const S=new ng({Fo:k=>{C?F(ye,`Not sending because RPC '${e}' stream ${i} is closed:`,k):(w||(F(ye,`Opening RPC '${e}' stream ${i} transport.`),y.open(),w=!0),F(ye,`RPC '${e}' stream ${i} sending:`,k),y.send(k))},Mo:()=>y.close()}),V=(k,b,O)=>{k.listen(b,N=>{try{O(N)}catch(U){setTimeout(()=>{throw U},0)}})};return V(y,Nn.EventType.OPEN,()=>{C||(F(ye,`RPC '${e}' stream ${i} transport opened.`),S.Qo())}),V(y,Nn.EventType.CLOSE,()=>{C||(C=!0,F(ye,`RPC '${e}' stream ${i} transport closed`),S.Ko())}),V(y,Nn.EventType.ERROR,k=>{C||(C=!0,mi(ye,`RPC '${e}' stream ${i} transport errored:`,k),S.Ko(new j(L.UNAVAILABLE,"The operation could not be completed")))}),V(y,Nn.EventType.MESSAGE,k=>{var b;if(!C){const O=k.data[0];re(!!O);const N=O,U=(N==null?void 0:N.error)||((b=N[0])===null||b===void 0?void 0:b.error);if(U){F(ye,`RPC '${e}' stream ${i} received error:`,U);const $=U.status;let W=function(g){const E=ie[g];if(E!==void 0)return hm(E)}($),v=U.message;W===void 0&&(W=L.INTERNAL,v="Unknown error status: "+$+" with message "+U.message),C=!0,S.Ko(new j(W,v)),y.close()}else F(ye,`RPC '${e}' stream ${i} received:`,O),S.Uo(O)}}),V(c,wc.STAT_EVENT,k=>{k.stat===vs.PROXY?F(ye,`RPC '${e}' stream ${i} detected buffering proxy`):k.stat===vs.NOPROXY&&F(ye,`RPC '${e}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{S.$o()},0),S}}function os(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class og{}class ag extends og{constructor(e,t,r,i){super(),this.authCredentials=e,this.appCheckCredentials=t,this.connection=r,this.serializer=i,this.F_=!1}M_(){if(this.F_)throw new j(L.FAILED_PRECONDITION,"The client has already been terminated.")}bo(e,t,r,i){return this.M_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([o,a])=>this.connection.bo(e,bs(t,r),i,o,a)).catch(o=>{throw o.name==="FirebaseError"?(o.code===L.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),o):new j(L.UNKNOWN,o.toString())})}Co(e,t,r,i,o){return this.M_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([a,c])=>this.connection.Co(e,bs(t,r),i,a,c,o)).catch(a=>{throw a.name==="FirebaseError"?(a.code===L.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),a):new j(L.UNKNOWN,a.toString())})}terminate(){this.F_=!0,this.connection.terminate()}}class lg{constructor(e,t){this.asyncQueue=e,this.onlineStateHandler=t,this.state="Unknown",this.x_=0,this.O_=null,this.N_=!0}B_(){this.x_===0&&(this.L_("Unknown"),this.O_=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,()=>(this.O_=null,this.k_("Backend didn't respond within 10 seconds."),this.L_("Offline"),Promise.resolve())))}q_(e){this.state==="Online"?this.L_("Unknown"):(this.x_++,this.x_>=1&&(this.Q_(),this.k_(`Connection failed 1 times. Most recent error: ${e.toString()}`),this.L_("Offline")))}set(e){this.Q_(),this.x_=0,e==="Online"&&(this.N_=!1),this.L_(e)}L_(e){e!==this.state&&(this.state=e,this.onlineStateHandler(e))}k_(e){const t=`Could not reach Cloud Firestore backend. ${e}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qn{constructor(e){this._byteString=e}static fromBase64String(e){try{return new qn(Ue.fromBase64String(e))}catch(t){throw new j(L.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new qn(Ue.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vu{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new j(L.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new de(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tu{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new j(L.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new j(L.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return Q(this._lat,e._lat)||Q(this._long,e._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
