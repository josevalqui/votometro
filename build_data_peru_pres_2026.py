...
NEW_STRUCTURE_FILE = r"C:\Users\josem\OneDrive\Proyectos\Votometro\Peru\Votaciones parlamentarias 2026\preguntas_20250311.xlsx"
...
def generate_from_new_structure():
    ...
    # Write out JSON
    out_path = os.path.join(OUTPUT_DIR, "combined_votes_peru_pres_2026.json")
